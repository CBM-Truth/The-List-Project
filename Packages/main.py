...
#post: prints out and writes to a file a list of locations mapped to distances in meteres cooresponding to the distance between
# that location and the UC Berkeley Campus. Locations are taken from an HTML 'dd' element embedded within the webpage.
def get_distances(): 
